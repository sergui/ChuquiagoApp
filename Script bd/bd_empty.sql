...
/* Procedure structure for procedure `asignar_asesor` */

/*!50003 DROP PROCEDURE IF EXISTS  `asignar_asesor` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `asignar_asesor`()
BEGIN
...
/* Procedure structure for procedure `padre_alumno` */

/*!50003 DROP PROCEDURE IF EXISTS  `padre_alumno` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `padre_alumno`(IN idc BIGINT, IN idt BIGINT)
BEGIN
