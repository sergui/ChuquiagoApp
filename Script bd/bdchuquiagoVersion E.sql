...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-04-2018 a las 17:11:29
...
--
DROP DATABASE IF EXISTS `bdchuquiago`;
...
INSERT INTO `tutor` (`id_tutor`, `nombres`, `paterno`, `materno`, `celular`, `telefono`, `domicilio`, `estado`, `id_user`) VALUES
(17, 'Luis', 'Mendoza', 'Ticona', '12345678', '12345678', 'Zona de Villa', 1, 20);
...
(20, 'L.Mendoza', '$2y$10$sWB3NeuJzpGvGiKaaETV3.1AiYto2yqVKKLhXrQetdLhgpOjlmO5O', 1, 3);
...
--
ALTER TABLE `asignatura`
  MODIFY `id_asignatura` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
...
--
ALTER TABLE `estudiante`
  MODIFY `id_rude` int(20) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tutor`
  MODIFY `id_tutor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
